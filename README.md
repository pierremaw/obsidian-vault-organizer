...
python _scripts/vault_organizer.py
```
- To assign a system wide hotkey to activate the bot, in my ~/.zshrc I created an alias for this, such that when I type obsidian into the shell my script runs.
```bash
